            ...
            .setOnClickListener {
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Adicionar", DialogInterface.OnClickListener { dialog, which ->
                        ...
                        Toast.makeText(this, "${transacaoCriada.valor} - ${transacaoCriada.categoria} - ${transacaoCriada.data.formataParaBrasileiro()} - ${transacaoCriada.tipo}", Toast.LENGTH_LONG).show()
                    })
